...
spids=["Allox_ar", "Andr_cur", "Andr_gro", "Andr_qln", "Andr_qrm", "Aula_tav", "Aylax_hy", "Beloc_tr", "Bior_pal", 'Callas_no', 'Calli_sp', 'Cecin_ib', 'Cerop_ma', 'Diast_ki', 'Dipl_spi', 'Escha_ac', 'Gana_sp1', 'Hedic_le', 'Irae_his', 'Isoc_cen', 'Lepto_bo', 'Lepto_cl', 'Lepto_he', 'Parn_nig', 'Pedia_ac', 'Peric_JH', 'Phaen_vi', 'Phana_JH', 'Prot_spe', 'Qwaq_sco', 'Syne_gif', 'Syne_ito', 'Syne_jap', 'Syne_umb', "Nasoniav", "Orussusa", "Micropld"]
...
if args.species=="sample": #this is to decide if the species argument is ...
        ...
        with open(args.species[0]) as s:
                headers=[line.strip() for line in s.readlines() if line.strip()!=""]
else:
        headers=args.species #... a command line list
