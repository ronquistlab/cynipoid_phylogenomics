...
taxonNames <- c(
    ...
    "Micropld","*Rhoophilus","*Xestophanes","*Synophromorpha","*Lithosaphonecrus",
    "*Saphonecrus+","*Synergus_clade3","*Synergus_clade2","*Synophrus+","*Synergus_clade1"
    )
...
displayNames <- c(
    ...
    "Synergus ito","Aulacidea tav","Isocolus cen","Fumariphilus hyp","Hedickiana lev","Phanacis sp",
    "Eschatocerus aca","Diplolepis spi","Pediaspis ace","Cecinothofagus iba","Nasonia vit","Orussus abi",
    "Microplitis dem","*Rhoophilus","*Xestophanes","*Synophromorpha","*Lithosaphonecrus",
    "*Saphonecrus+","*Synergus_clade3","*Synergus_clade2","*Synophrus+","*Synergus_clade1"
    )
