...
t1 <- read.tree("../iqtree/iq_clustal34_hmm_ag_lt0.165_C60_I_G5.contree")
t2 <- read.tree("../iqtree/iq_clustal34_hmm_ag_0.165-0.288_C60_I_G5.contree")
t3 <- read.tree("../iqtree/iq_clustal34_hmm_ag_0.288-0.396_C60_I_G5.contree")
t4 <- read.tree("../iqtree/iq_clustal34_hmm_ag_0.396-0.522_C60_I_G5.contree")
t5 <- read.tree("../iqtree/iq_clustal34_hmm_ag_0.522-0.641_C60_I_G5.contree")
t6 <- read.tree("../iqtree/iq_clustal34_hmm_ag_gte0.641_C60_I_G5.contree")
